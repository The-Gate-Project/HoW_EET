...
IF WEIGHT #7
~False()GlobalLT("IWD1_CHAPTER","GLOBAL",1)~ THEN BEGIN 0
  SAY @25081
...
IF WEIGHT #6
~False()Global("IWD1_CHAPTER","GLOBAL",1)~ THEN BEGIN 8
  SAY @25103
...
IF WEIGHT #5
~False()Global("IWD1_CHAPTER","GLOBAL",2)~ THEN BEGIN 16
  SAY @25120
...
IF WEIGHT #4
~False()Global("IWD1_CHAPTER","GLOBAL",3)~ THEN BEGIN 26
  SAY @25139
...
IF WEIGHT #3
~False()Global("IWD1_CHAPTER","GLOBAL",4)~ THEN BEGIN 45
  SAY @25234
...
IF WEIGHT #2
~False()Global("IWD1_CHAPTER","GLOBAL",5)~ THEN BEGIN 51
  SAY @25246
...
IF WEIGHT #1
~False()Global("IWD1_CHAPTER","GLOBAL",6)~ THEN BEGIN 57
  SAY @25265
...
~True()~ THEN BEGIN 69
  ...
  IF ~GlobalGT("Body_Count","GLOBAL",0)
      Global("Emmerich_Quest","GLOBAL",3)
      AreaType(IWDAREA)~ THEN REPLY @25293 GOTO 71
  IF ~GlobalLT("Hjollder_Quest","GLOBAL",4)
      AreaType(IWDAREA)~ THEN REPLY @25294 GOTO 72
  IF ~GlobalLT("Hjollder_Quest","GLOBAL",9)
      AreaType(IWDAREA)~ THEN REPLY @25295 GOTO 73
  IF ~Global("Hjollder_Quest","GLOBAL",9)
      AreaType(IWDAREA)~ THEN REPLY @25296 GOTO 74
  IF ~Global("Hjollder_Quest","GLOBAL",12)
      AreaType(IWDAREA)~ THEN REPLY @25297 GOTO 75
  IF ~Global("Know_Vexing","GLOBAL",1)
      !Global("Know_Truename","GLOBAL",1)
      AreaType(IWDAREA)~ THEN REPLY @25298 DO ~SetGlobal("Know_Truename","GLOBAL",1)~ GOTO 76
  IF ~~ THEN REPLY @25129 DO ~StartCutScene("gnDstSlf")~ EXIT
END
